...
#------------------------------
    ...
    regions.append([1, 10, 0., 1e9, -360, 360, -90, 90])
...
#-------------------
    ...
    topofiles.append([-3, 1, 1, 0.0, 1e10, topodir+'TAU_A_750m_c.ttm3'])

    # Harbour grid needed for fine grid runs:
    #topofiles.append([-3, 1, 1, 0.0, 1e10, \
    #        topodir+'TAU_Whole_Harbour_10_m_srf6.ttm3'])
